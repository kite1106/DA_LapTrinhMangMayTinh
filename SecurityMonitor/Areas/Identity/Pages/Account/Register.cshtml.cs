...
namespace SecurityMonitor.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private ApplicationUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Không thể tạo instance của '{nameof(ApplicationUser)}'. Đảm bảo class có constructor không tham số.");
            }
        }
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("UserStore phải hỗ trợ email.");
            }
